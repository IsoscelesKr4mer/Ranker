  ...
  return (
    <PageLayout maxWidth="xl">
      <div className="space-y-12 py-8">
        ...
        >
          <p className="text-xs font-bold text-violet-400/80 tracking-widest uppercase">Shared Ranking</p>
          <h1
          ...
          <p className="text-white/40 text-sm">
            {items.length} items ranked in {comparisonsMade} comparison{comparisonsMade !== 1 ? 's' : ''}
          </p>
        </motion.div>
