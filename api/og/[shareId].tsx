    ...
    >
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '18px', position: 'relative' }}>
        <div style={{ display: 'flex', flexDirection: 'column', maxWidth: '900px' }}>
          <div style={{ fontSize: '11px', fontWeight: 700, letterSpacing: '4px', color: 'rgba(255,255,255,0.28)', textTransform: 'uppercase', marginBottom: '10px', display: 'flex' }}>
            MY RANKING
          </div>
          <div style={{ fontSize: '42px', fontWeight: 800, color: '#ffffff', lineHeight: 1.1, display: 'flex' }}>
            {list_title}
          </div>
        </div>
        <div style={{ fontSize: '14px', fontWeight: 700, color: 'rgba(255,255,255,0.15)', letterSpacing: '4px', display: 'flex' }}>
          RANKER
        </div>
      </div>

      {/* Divider */}
      <div style={{ height: '1px', background: 'rgba(255,255,255,0.1)', marginBottom: '18px', display: 'flex' }} />
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '6px', flex: 1 }}>
        {top5.map((item, idx) => (
          ...
          >
            ...
            {/* Vertical rule */}
            <div style={{ width: '1px', height: '28px', background: 'rgba(255,255,255,0.08)', display: 'flex' }} />
            ...
            <div style={{ display: 'flex', flexDirection: 'column', flex: 1, overflow: 'hidden' }}>
              ...
              {item.subtitle ? (
                <div style={{ fontSize: '13px', color: 'rgba(255,255,255,0.36)', marginTop: '2px', display: 'flex' }}>
                  {item.subtitle}
                </div>
              ) : null}
            </div>
        ...
        {/* "And N more..." if list is longer than 5 */}
        {results.length > 5 && (
          <div style={{
            display: 'flex',
            alignItems: 'center',
            ...
            <div style={{ width: '52px', display: 'flex' }} />
            <div style={{ width: '1px', height: '20px', background: 'rgba(255,255,255,0.06)', display: 'flex' }} />
      ...
      {/* Footer */}
      <div style={{ display: 'flex', alignItems: 'center', gap: '16px', marginTop: '14px', position: 'relative' }}>
        <div style={{ height: '1px', flex: 1, background: 'rgba(255,255,255,0.06)', display: 'flex' }} />
        <div style={{ fontSize: '12px', color: 'rgba(255,255,255,0.18)', letterSpacing: '1px', display: 'flex' }}>
          ranker.app
        </div>
      </div>
    </div>,
